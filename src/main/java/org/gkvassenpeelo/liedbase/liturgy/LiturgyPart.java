...
public class LiturgyPart {
	...
	public enum Type {
		welcome, blank, song, gathering, prair, law, lecture, votum, amen, endOfMorningService, endOfAfternoonService, scripture, agenda, liturgyOverview, extendedScripture, emptyWithLogo, video
	};
