...
public class BibleTest {
	...
	public void getBiblePartTestFromText() throws Exception {
		...
		List<BiblePartFragment> bp = Bible.getBiblePart("bgt", "genesis", 1, new VerseRange(1, 2));
		...
		bp = Bible.getBiblePart("bgt", "genesis", 1, new VerseRange(13, 17));
	...
	public void getBiblePartNonExistentTest() throws Exception {
		...
		try {
			Bible.getBiblePart("nbv", "Exoddus", 2, new VerseRange(1, 5));
		} catch (BibleException e) {
